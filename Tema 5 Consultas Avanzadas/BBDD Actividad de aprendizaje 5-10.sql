...
select date_add(curdate(),interval 1 day) as mañana ,
 date_add(curdate(),interval 1 month) as mesSiguiente,
 date_add(curdate(),interval -1 day) as ayer,
 date_add(curdate(),interval -1 month) as mesAnterior;
